    ...
    <el-card>
      <el-form label-width="80px" :inline="true" ref="form" :model="form">
        ...
        <el-form-item>
          ...
          <el-button type="primary" v-if="$store.state.role!='学生'" @click="add">+新增学科</el-button>
        </el-form-item>
      </el-form>
    </el-card>
      ...
      <el-table :data="tableData" style="width: 100%" class="table">
        ...
        <el-table-column label="操作" width="270px"  v-if="$store.state.role!='学生'">
          <template slot-scope="scope">
            ...
            <el-button   v-if="$store.state.role.includes('管理员')" @click="del(scope.row.id)">删除</el-button>
          </template>
        </el-table-column>
